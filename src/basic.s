; Enhanced BASIC to assemble under cc65, $ver 2.22p5 plus RP6502/cc65 changes
...
;
; Major changes made after moving to CC65 for RP6502 project
;
; p6.0  add klaus2m5's mixed case mode.
...
ccflag            = $03       ; BASIC CTRL-C flag, 00 = enabled, 01 = dis
ccbyte            = $04       ; BASIC CTRL-C byte
ccnull            = $05       ; BASIC CTRL-C byte timeout
ccvecl            = $06       ; ctrl c check vector low byte
ccvech            = ccvecl+1  ; ctrl c check vector high byte
;                 = $08       ; unused
;                 = $09       ; unused
...
;                 = $14       ; Start of cc65 registers, see basic.cfg
;                 = $5A       ; Last of cc65 registers
...
; copy block from StrTab to LAB_WARM
